...
function index() {
  ...
  return (
    <div className='max-w-5xl m-auto flex  justify-center flex-col min-h-screen space-y-3'>
     <div className='w-full text-center '> <SC.Title className='text-7xl font-semibold flex w-5/6 mx-auto  justify-center items-center min-h-[120px] mb-8 '>File Conversion place center </SC.Title></div>
    {/* <Dropzones /> */}
    <Customezone />
    </div>
  )
